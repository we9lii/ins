        ...
        <div className="bg-white rounded-xl shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col h-full overflow-hidden">
                            ...
                            visibleLines.map((line) => (
                                <tr key={line.id} className={`group hover:bg-slate-50 transition-colors ${isEditingId === line.id ? 'bg-blue-50/40' : ''}`}>
                                    ...
                                    <td className="p-2 md:p-3">
                                        <span className={`inline-flex px-1.5 md:px-2 py-0.5 rounded text-[8px] md:text-[10px] font-medium whitespace-nowrap ${REASON_COLORS[line.reason]}`}>
            ...
            <div id="draft-area" className="border-t border-slate-100 bg-white p-3 md:p-5 shadow-[0_-5px_25px_-5px_rgba(0,0,0,0.05)] z-20 flex-shrink-0 relative">
                ...
                <div className="space-y-3 md:space-y-3" onKeyDown={handleKeyDown}>
                    ...
                    <div className="hidden md:grid grid-cols-12 gap-x-4 gap-y-3">
                        {/* Row 1: Core Data */}
                        <div className="col-span-2">
                            <div className="relative group">
                                <Calendar size={13} className={iconClass} />
                                <input type="date" className={`${inputClass} ${withRightIcon}`} value={draft.date} onChange={e => handleDraftChange('date', e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="col-span-2">
                            <div className="relative group">
                                ...
                                <select className={`${inputClass} ${withRightIcon} appearance-none`} value={draft.reason} onChange={e => handleDraftChange('reason', e.target.value as ExpenseReason)}>
                        ...
                        <div className="col-span-3">
                            <div className="relative group">
                                ...
                                <input type="text" placeholder="الجهة المستفيدة (الشركة/المورد) *" className={`${inputClass} ${withRightIcon}`} value={draft.company} onChange={e => handleDraftChange('company', e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="col-span-2">
                            <div className="relative group">
                                ...
                                <input type="text" placeholder="الرقم الضريبي" className={`${inputClass} ${withRightIcon} font-mono`} value={draft.tax_number} onChange={e => handleDraftChange('tax_number', e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="col-span-2">
                            <div className="relative group">
                                <Hash size={13} className={iconClass} />
                                <input type="text" placeholder="رقم الفاتورة" className={`${inputClass} ${withRightIcon} font-mono`} value={draft.invoice_number} onChange={e => handleDraftChange('invoice_number', e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="col-span-4">
                            <div className="relative group">
                                ...
                                <input type="text" placeholder="البيان (شرح المصروف) *" className={`${inputClass} ${withRightIcon}`} value={draft.description} onChange={e => handleDraftChange('description', e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="col-span-1">
                            <div className="relative group">
                                ...
                                <input type="number" placeholder="رسوم إضافية" className={`${inputClass} !pr-7 !pl-1`} value={draft.bank_fees || ''} onChange={e => handleDraftChange('bank_fees', parseFloat(e.target.value))} />
                            </div>
                        </div>
                        ...
                        <div className="col-span-2">
                            <div className="relative group">
                                ...
                                <input type="text" placeholder="اسم المشتري" className={`${inputClass} ${withRightIcon}`} value={draft.buyer_name} onChange={e => handleDraftChange('buyer_name', e.target.value)} />
                            </div>
                        </div>

                        <div className="col-span-2">
                            <input type="text" placeholder="ملاحظات إضافية..." className={inputClass} value={draft.notes} onChange={e => handleDraftChange('notes', e.target.value)} />
                        </div>

                        <div className="col-span-1">
                            <button
                                onClick={handleSubmitDraft}
                                className={`w-full h-9 rounded-lg text-white shadow-sm hover:shadow-md transition-all flex items-center justify-center active:scale-95 ${isEditingId ? 'bg-orange-500 hover:bg-orange-600' : 'bg-emerald-500 hover:bg-emerald-600'
                                    }`}
                                title={isEditingId ? 'حفظ التعديلات' : 'إضافة السطر'}
                            >
                    ...
                    <div className="md:hidden grid grid-cols-12 gap-1.5">
                        {/* Row 1: Amount & Reason */}
                        ...
                        <div className="col-span-7">
                            <select className={`${inputClass}`} value={draft.reason} onChange={e => handleDraftChange('reason', e.target.value as ExpenseReason)}>
                                {REASON_OPTIONS.map(r => <option key={r} value={r}>{r}</option>)}
                            </select>
                        </div>
                        ...
                        <div className="col-span-4">
                            <input type="date" className={`${inputClass} px-1 md:px-2 text-center`} value={draft.date} onChange={e => handleDraftChange('date', e.target.value)} />
                        </div>
                        ...
                        <div className="col-span-3">
                            <input type="number" placeholder="رسوم" className={`${inputClass} px-1 md:px-2 text-center`} value={draft.bank_fees || ''} onChange={e => handleDraftChange('bank_fees', parseFloat(e.target.value))} />
                        </div>
                        <div className="col-span-4">
                        ...
                        <div className="col-span-12 mt-1">
                            <button
                                onClick={handleSubmitDraft}
                                className={`w-full h-8 rounded-lg text-white font-bold text-[10px] shadow-sm flex items-center justify-center gap-1.5 active:scale-95 transition-all ${isEditingId ? 'bg-orange-500' : 'bg-emerald-500'
                                    }`}
                            >
                                {isEditingId ? <ArrowUpCircle size={14} /> : <Plus size={14} />}
